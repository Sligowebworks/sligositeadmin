...
Set Conn = Server.CreateObject("ADODB.Connection")
	...
	' session("connstring") = "Provider=SQLOLEDB.1;Password=zenmind;Persist Security Info=True;User ID=sa;Initial Catalog=SligoSite_LearnerSupport;Data Source=PARADISO"
...
<TABLE CELLPADDING=3 CELLSPACING=1 ALIGN="CENTER" BORDER="1" BGCOLOR="">
	<TR>
		...
		<TD BGCOLOR="#FFFFCC" COLSPAN = 3 align=right><FONT FACE="Arial, Helvetica, sans-serif" SIZE="2" COLOR="BLUE"><a HREF="AdminEdit.asp?id=0&mid=<%=menuid%>&Add=Y">Add SIDE item&nbsp;</FONT></TD>
	</TR>
