...
<TABLE WIDTH="600" BORDER="0" BGCOLOR="WHITE" CELLSPACING="3" CELLPADDING="3" ALIGN="CENTER"> 
	...
	<TR> 
		<TD>
			<FONT FACE=" Arial, Helvetica, sans-serif" SIZE="2"><B>Width of graphic:</B></FONT>
		</TD> 
		<TD WIDTH="334" HEIGHT="25" colspan=3><FONT SIZE="2" FACE="Arial, Helvetica, sans-serif"> 
			<INPUT NAME="width" SIZE="3" VALUE="<%=width%>">
			</FONT>
		</TD> 
	</TR> 
	<TR> 
		<TD>
			<FONT FACE=" Arial, Helvetica, sans-serif" SIZE="2"><B>Height of graphic:</B></FONT>
		</TD> 
		<TD WIDTH="334" HEIGHT="25" colspan=3><FONT SIZE="2" FACE="Arial, Helvetica, sans-serif"> 
			<INPUT NAME="height" SIZE="3" VALUE="<%=height%>">
			</FONT>
		</TD> 
	</TR> 
	<TR> 
		<TD>
			<FONT FACE=" Arial, Helvetica, sans-serif" SIZE="2"><B>Offset of graphic:</B></FONT>
		</TD> 
		<TD WIDTH="334" HEIGHT="25" colspan=3><FONT SIZE="2" FACE="Arial, Helvetica, sans-serif"> 
			<INPUT NAME="offset" SIZE="3" VALUE="<%=offset%>">
			</FONT>
		</TD> 
	</TR> 
	<%END IF%>
